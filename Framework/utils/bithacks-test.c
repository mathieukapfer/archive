...
void test_B_MASK() {
  ...
  x = B8(11111111);
  TEST_OK(B_MASK(x, 0), B8(00000000));
  TEST_OK(B_MASK(x, 1), B8(00000001));
  TEST_OK(B_MASK(x, 2), B8(00000011));
  TEST_OK(B_MASK(x, 3), B8(00000111));
  TEST_OK(B_MASK(x, 4), B8(00001111));
  TEST_OK(B_MASK(x, 5), B8(00011111));
  TEST_OK(B_MASK(x, 6), B8(00111111));
  TEST_OK(B_MASK(x, 7), B8(01111111));
  TEST_OK(B_MASK(x, 8), B8(11111111));
...
void test_B_SELECT() {
  unsigned char x;
  x = B8(10000000);
  TEST_OK(B_SELECT(x, 7, 8), B8(00000001));

  x = B8(00000001);
  TEST_OK(B_SELECT(x, 0, 1), B8(00000001));

  x = B8(00000110);
  TEST_OK(B_SELECT(x, 2, 6), B8(00000001));

  x = B8(10111101);
  TEST_OK(B_SELECT(x, 2, 6), B8(00001111));

  x = B8(11111111);
  TEST_OK(B_SELECT(x, 2, 6), B8(00001111));

  x = B8(00000011);
  TEST_OK(B_SELECT(x, 0, 2), B8(00000011));
}
